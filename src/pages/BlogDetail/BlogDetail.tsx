                                    ...
                                    <li>
                                        ...
                                        <div className="mt-[14px] mb-[35px]">
                                            <p className="text-[13px]">
                                                Đề xuất này là một tình huống đôi bên cùng có lợi sẽ tạo ra một mô hình
                                                xuất sắc thay đổi và tạo ra sự gia tăng gấp nhiều lần trong các sản phẩm
                                                tốt hơn sự hiểu biết
                                            </p>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li className="ml-8 lg:ml-16">
                                        ...
                                        <div className="mt-[14px] mb-[35px]">
                                            <p className="text-[13px]">
                                                ...
                                                paradigm shift, and produce a multi-fold increase in deliverables a
